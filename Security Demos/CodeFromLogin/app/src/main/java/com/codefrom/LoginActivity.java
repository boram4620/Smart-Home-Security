...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public String sendPost(String url, String username, String password) {
        ...
        params.add(new BasicNameValuePair("app_key", "codefrom"));
        ...
        httpRequest.addHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; rv:11.0) Gecko/20100101 Firefox/11.0");
        httpRequest.addHeader("Origin", "http://api.weibo.com");
        httpRequest.addHeader("Referer", "http://www.weibo.com");
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == 200) {
                ...
                if (cookies.isEmpty()) {
                    System.out.println("Cookies not set.");
                } else {

                    System.out.println("Cookies is set.");

                    for (int i = 0; i < cookies.size(); i++) {

                        Cookie cookie = cookies.get(i);
                        Log.d("Get Cookie", cookies.get(i).getName() + "=" + cookies.get(i).getValue());
                        cookieManager = CookieManager.getInstance();
                        Log.d("Saved Cookie", cookies.get(i).getName() + "=" + cookies.get(i).getValue());
                        String cookieString = cookie.getName() + "=" + cookie.getValue() + "; domain=" + cookie.getDomain();
                        cookieManager.setCookie("http://www.weibo.com/", cookieString);
                    }
                }
                return strResult;
            } else {
    ...
    Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if ("1".equals(loginInfo.getStatus())) {
                ...
                bundle.putString("username", "Justin Guo");
